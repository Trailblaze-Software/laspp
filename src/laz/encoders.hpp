...
typedef std::variant<std::unique_ptr<LASPointFormat0Encoder>, std::unique_ptr<GPSTime11Encoder>,
                     std::unique_ptr<RGB12EncoderV1>, std::unique_ptr<RGB12EncoderV2>,
                     std::unique_ptr<RGB14Encoder>, std::unique_ptr<BytesEncoder>,
                     std::unique_ptr<LASPointFormat6EncoderV3>,
